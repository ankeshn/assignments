...
class Assignment3Q10{
	public static void main(String[] args) {
		...
		movies_detail m1=new movies_detail("TIGER ZINDA HAI","SALMAN KHAN", "KATRINA KAIF", "ACTION", "ROMANCE");  
		movies_detail m2=new movies_detail("Veer Zaara", "Shahrukh Khan","Preety Zinta","Romance");  
